...
var instrumentCRUD = {}; // globally available object

instrumentCRUD.list = function (targetId) {

    var dataList = document.createElement("div");
    dataList.id = "dataList"; // set the id so it matches CSS styling rules in listStyle.css
    dataList.innerHTML = "<h2>Instruments</h2>";
    ...
    ajax('webAPIs/getAllInstrumentsAPI.jsp', setListUI, 'content');
